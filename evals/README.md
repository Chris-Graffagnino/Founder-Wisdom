...
- `scenarios.yaml` — the eval set. 33 scenarios plus five global invariants.
...
Thirty-three scenarios is a bit over an hour. A full pass is warranted when `SKILL.md`
