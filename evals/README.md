...
- `scenarios.yaml` — the eval set. 35 scenarios plus five global invariants.
...
Thirty-five scenarios is a bit over an hour. A full pass is warranted when `SKILL.md`
