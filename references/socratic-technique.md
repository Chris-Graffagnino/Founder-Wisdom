...
| Rich or king | "Of the last four decisions that traded ownership against control — the co-founder split, equity to hires, whose money you took, who runs this in five years — how many went the same way? If the answer isn't four, say which one you're actually optimizing for." |
