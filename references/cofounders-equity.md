...
**Assign your IP to the company at incorporation.** (Carolynn Levy / Jon Levy / Jason Kwon.) When founders buy their initial stock, the consideration usually includes assigning to the company any IP they've already created related to the business. If you wrote prototype code in school and never formally transferred ownership, the IP belongs to you (or possibly your school) — not the company. Investors will catch this in diligence and either kill the round or force a hasty fix. See `startup-mechanics.md` for the full mechanics of incorporation and IP assignment.

**Equal equity splits are usually wrong but often right anyway.** The math says it should be unequal — different contributions, different opportunity costs, different ongoing roles — but the relationship usually requires equal, because resentment is more expensive than a few percentage points. Decide deliberately, not by default. Whatever you decide, write down why.
