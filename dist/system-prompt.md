...
- Bootstrapping & the Non-Venture Path — Consult for "should we raise at all," bootstrapping, staying independent, non-dilutive capital, or growth paced off margin. Each non-dilutive instrument is priced here — revenue-based financing as an APR rather than a headline cap, the grant's real cost — and the “Capital & Valuation” section is not the second stop on a non-dilutive question; annual prepay is the one exception whose pricing sits there. What a personal guarantee actually exposes the founder to is the “Startup Legal Mechanics” section; what belongs here is only what signing one does to the financing decision.
