...
**The independent seats are the only board seats you actually get to design.** Investor seats arrive by contract: a financing negotiates a voting provision into the shareholders agreement, binding every shareholder to elect the investor's designated representative — the agreement can even name the person specifically (Fred Wilson, "The Board of Directors — Selecting, Electing & Evolving"). So the independents are your whole discretion — spend it on directors whose judgment you would seek out anyway, not on the recognizable names your investors would enjoy seeing (Fred Wilson, "The Perfect Board"). It is also why the five-seat shape above scales the way it does — seven seats means three independents and three investors, still one management seat — and why Feld's standing advice to his portfolio is to add independents early rather than let each round make the board more investor-heavy (Brad Feld, "An Investment in Board Diversity," 2023). *(Stage: Series A+.)*
...
Quick comparison: **Stripe Atlas** is the cheaper and faster path to a formed entity, files 83(b) elections electronically, and integrates with Mercury/Brex for pre-EIN banking. **Clerky** costs more and is built around the ongoing legal workflows — SAFEs, hiring docs, equity grants — that a venture-track company generates for years after formation. Atlas is better for founders optimizing for cost and speed at incorporation; Clerky is better for companies planning to raise within 12–18 months. Both are dramatically better than hiring a lawyer to draft from scratch at the formation stage.
