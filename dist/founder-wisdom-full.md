...
**Don't delegate the thing you're best at.** (Chesky, crediting Ben Horowitz's "The Product CEO Paradox.") The standard advice is to hand off what others can do so you can spend your time on what only you can do, and founders reliably invert it: the product-led founder who hires a CPO has delegated the hardest-to-replace thing they do and kept the parts anyone could have run. Airbnb's version of the discipline is structural rather than aspirational — there is no CPO title. Which function you hand off first is a different question from whether you delegate at all, and this axiom only answers the first.
